...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕F4CK▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕B4 M4▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
...
\033[1;91m☞ Auther     : FULLBROKEN890
\033[1;92m☞ WhatsApp   : ??
\033[1;95m☞ Facebook   : https://www.facebook.com/Shahabkhan0007
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update SHAHAB_TOLLl')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/SHAHAB')
	    os.system('cd $HOME && git clone https://github.com/fullbroken890/shahab')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 97866666666666✓')
	    psb('WellCome To B4_BALOCH')
	    psb('Congratulations MR_SHAHAB Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 786786✓')
	    psb('🔓Password ☆ 786786✓')
	    psb('Subscrib My Youtube Channel FULL__BROKEN✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/MR_SHAHAB && python2 Shahab.py')
	elif bm =='3':
